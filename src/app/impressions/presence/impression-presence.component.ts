...
declare var jQuery;
@Component({
  templateUrl: 'impression-presence.component.html',
  styleUrls: [],

})
export class ImpressionPresenceComponent implements OnInit {
  ...
  generateAttestation() {
    ...
    this.busy = this.impressionService.attestationPresence(this.langue, this.codeStudent)
      .subscribe(
        (data) => {
          if (this.langue === 1) {
